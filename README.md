...
[![Tests](https://img.shields.io/badge/tests-178%20passing-brightgreen)](./backend/tests)
...
| **Testing** | pytest, pytest-asyncio — **178 tests** across 17 test files |
...
│   └── tests/                    # 178 pytest tests across 17 files
├── frontend/
│   └── src/
...
178 pytest tests across 17 test files covering:
...
| Layer | Method | Status |
|-------|--------|--------|
| **Software correctness** | 178 automated tests, CI pipeline, mock + live provider coverage | ✅ Complete |
...
4. Run `pytest -v` — all 178 tests must pass
