...
def test_good_candidate_scores_well(engine, good_earnings, good_price, good_vol, good_chain, good_liquidity):
    result = engine.score("AAPL", good_earnings, good_price, good_vol, good_chain, good_liquidity)
...
def test_risk_warnings_present(engine, good_earnings, good_price, good_vol, good_chain, good_liquidity):
    result = engine.score("AAPL", good_earnings, good_price, good_vol, good_chain, good_liquidity)
    assert len(result.risk_warnings) > 0
    assert any("decision-support" in w.lower() for w in result.risk_warnings)


def test_rationale_not_empty(engine, good_earnings, good_price, good_vol, good_chain, good_liquidity):
    result = engine.score("AAPL", good_earnings, good_price, good_vol, good_chain, good_liquidity)
...
def test_unverified_earnings_penalized(engine, good_price, good_vol, good_chain, good_liquidity):
    ...
    result_unverified = engine.score("TEST", unverified, good_price, good_vol, good_chain, good_liquidity)
    result_confirmed = engine.score("TEST", confirmed, good_price, good_vol, good_chain, good_liquidity)
